...
export default function LayoutResponsavel() {
  ...
  const navigation = [
    { name: 'Dashboard', path: '/responsavel/dashboard' },
    { name: 'Cobranças', path: '/responsavel/cobrancas' },
    { name: 'Pagamentos', path: '/responsavel/pagamentos' },
    { name: 'Meus Dados', path: '/responsavel/dados' },
  ]
    ...
    <div className="min-h-screen bg-white">
      <header className="h-20 border-b border-gray-medium bg-white flex items-center justify-between px-8 fixed top-0 left-0 right-0 z-10">
        <div className="flex items-center gap-4">
          ...
          <span className="text-lg font-medium text-gray-dark">Portal do Responsável</span>
        </div>
        <div className="flex items-center gap-4">
